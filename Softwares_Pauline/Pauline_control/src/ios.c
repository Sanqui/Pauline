...
io_def ios_definition[]=
{
	...
	{"DRIVES_PORT_PIN10_OUT",              OUT_OC,   0x23,  0},
	...
	{"DRIVES_PORT_PIN12_OUT",              OUT_OC,   0x23,  1},
	...
	{"DRIVES_PORT_PIN14_OUT",              OUT_OC,   0x23,  2},
	...
	{"DRIVES_PORT_PIN06",                  OUT_OC,   0x23,  3},
	{"DRIVES_PORT_PIN6_OUT",               OUT_OC,   0x23,  3},
	{"DRIVES_PORT_PIN06_OUT",              OUT_OC,   0x23,  3},

	{"DRIVES_PORT_MOTON",                  OUT_OC,   0x23,  4},
	{"DRIVES_PORT_MOTEB",                  OUT_OC,   0x23,  4},
	{"DRIVES_PORT_PIN16",                  OUT_OC,   0x23,  4},
	{"DRIVES_PORT_PIN16_OUT",              OUT_OC,   0x23,  4},
	...
	{"DRIVES_PORT_PIN2",                   OUT_OC,   0x43,  0},
	{"DRIVES_PORT_PIN2_OUT",               OUT_OC,   0x43,  0},
	{"DRIVES_PORT_PIN02",                  OUT_OC,   0x43,  0},
	{"DRIVES_PORT_PIN02_OUT",              OUT_OC,   0x43,  0},
	{"DRIVES_PORT_MODESELECT",             OUT_OC,   0x43,  0},

	{"DRIVES_PORT_PIN4",                   OUT_OC,   0x43,  1},
	{"DRIVES_PORT_PIN4_OUT",               OUT_OC,   0x43,  1},
	{"DRIVES_PORT_PIN04",                  OUT_OC,   0x43,  1},
	{"DRIVES_PORT_PIN04_OUT",              OUT_OC,   0x43,  1},

	{"DRIVES_PORT_X68000_OPTIONSEL0_OUT",  OUT_OC,   0x43,  2},
	{"DRIVES_PORT_PIN1",                   OUT_OC,   0x43,  2},
	{"DRIVES_PORT_PIN1_OUT",               OUT_OC,   0x43,  2},
	{"DRIVES_PORT_PIN01",                  OUT_OC,   0x43,  2},
	{"DRIVES_PORT_PIN01_OUT",              OUT_OC,   0x43,  2},

	{"DRIVES_PORT_X68000_OPTIONSEL1_OUT",  OUT_OC,   0x43,  3},
	{"DRIVES_PORT_PIN3",                   OUT_OC,   0x43,  3},
	{"DRIVES_PORT_PIN3_OUT",               OUT_OC,   0x43,  3},
	{"DRIVES_PORT_PIN03",                  OUT_OC,   0x43,  3},
	{"DRIVES_PORT_PIN03_OUT",              OUT_OC,   0x43,  3},

	{"DRIVES_PORT_X68000_OPTIONSEL2_OUT",  OUT_OC,   0x43,  4},
	{"DRIVES_PORT_PIN5",                   OUT_OC,   0x43,  4},
	{"DRIVES_PORT_PIN5_OUT",               OUT_OC,   0x43,  4},
	{"DRIVES_PORT_PIN05",                  OUT_OC,   0x43,  4},
	{"DRIVES_PORT_PIN05_OUT",              OUT_OC,   0x43,  4},

	{"DRIVES_PORT_X68000_OPTIONSEL3_OUT",  OUT_OC,   0x43,  5},
	{"DRIVES_PORT_PIN7",                   OUT_OC,   0x43,  5},
	{"DRIVES_PORT_PIN7_OUT",               OUT_OC,   0x43,  5},
	{"DRIVES_PORT_PIN07",                  OUT_OC,   0x43,  5},
	{"DRIVES_PORT_PIN07_OUT",              OUT_OC,   0x43,  5},

	{"DRIVES_PORT_X68000_BLINK_OUT",       OUT_OC,   0x43,  6},
	{"DRIVES_PORT_PIN13",                  OUT_OC,   0x43,  6},
	{"DRIVES_PORT_PIN13_OUT",              OUT_OC,   0x43,  6},

	{"DRIVES_PORT_X68000_LOCK_OUT",        OUT_OC,   0x43,  7},
	{"DRIVES_PORT_PIN11",                  OUT_OC,   0x43,  7},
	{"DRIVES_PORT_PIN11_OUT",              OUT_OC,   0x43,  7},

	{"DRIVES_PORT_X68000_EJECT_OUT",       OUT_OC,   0x43,  8},
	{"DRIVES_PORT_PIN9",                   OUT_OC,   0x43,  8},
	{"DRIVES_PORT_PIN9_OUT",               OUT_OC,   0x43,  8},
	{"DRIVES_PORT_PIN09",                  OUT_OC,   0x43,  8},
	{"DRIVES_PORT_PIN09_OUT",              OUT_OC,   0x43,  8},

	{"LED_LED1_OUT",                       OUT_PP,   0x40,  0},
	{"LED_LED2_OUT",                       OUT_PP,   0x40,  1},

	{"EXPANSION_PORT_TRIS_IO0_PIN07_OUT",  OUT_PP,   0x40,  2},
	{"EXPANSION_PORT_TRIS_IO1_PIN08_OUT",  OUT_PP,   0x40,  3},
	{"EXPANSION_PORT_TRIS_IO2_PIN09_OUT",  OUT_PP,   0x40,  4},
	{"EXPANSION_PORT_TRIS_IO3_PIN10_OUT",  OUT_PP,   0x40,  5},
	{"EXPANSION_PORT_EXT_IO_OUT",          OUT_OC,   0x40,  6},

	{"EXPANSION_PORT_TRIS_IO0_PIN07_OE",   CTRL,     0x41,  2},
	{"EXPANSION_PORT_TRIS_IO1_PIN08_OE",   CTRL,     0x41,  3},
	{"EXPANSION_PORT_TRIS_IO2_PIN09_OE",   CTRL,     0x41,  4},
	{"EXPANSION_PORT_TRIS_IO3_PIN10_OE",   CTRL,     0x41,  5},

	{"EXPANSION_PORT_TRIS_IO0_PIN07_IN",  INPUT_ST,  0x42,  2},
	{"EXPANSION_PORT_TRIS_IO1_PIN08_IN",  INPUT_ST,  0x42,  3},
	{"EXPANSION_PORT_TRIS_IO2_PIN09_IN",  INPUT_ST,  0x42,  4},
	{"EXPANSION_PORT_TRIS_IO3_PIN10_IN",  INPUT_ST,  0x42,  5},
	{"EXPANSION_PORT_EXT_IO_IN",          INPUT_ST,  0x42,  6},
	{"EXPANSION_PORT_EXT_INT_IN",         INPUT_ST,  0x42,  7},
